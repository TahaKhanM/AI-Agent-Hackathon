...
| [08-landscape-update-2026-07-18.md](08-landscape-update-2026-07-18.md) | **Post-DIRECTION update (18 Jul)**: incident.io head-to-head (founders ex-Monzo; Slack-approve-then-execute already in their AI SRE definition), gate commoditisation (Azure permission gate, PagerDuty pre-approved remediations, ServiceNow auto-approval GA), Gartner guardian-agents <1% spend, HumanLayer pivot, Amagi agentic media ops; re-test of every DIRECTION.md differentiation claim | Whether the 6-Jul wedge still holds, claim by claim |
| [08b-verified-claims-2026-07-18.md](08b-verified-claims-2026-07-18.md) | Adversarially-verified claim ledger from the 18-Jul deep-research fleet (5 angles, ~15 sources, 3-vote refutation per claim) covering the five research questions incl. buyer-evidence and EU AI Act reality-check | Which 18-Jul claims survived refutation |
