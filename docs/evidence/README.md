...
| Jira is a live, real ACL source (roles, membership, permission schemes flip via API) | roles `precedent-rights-ops`=10007, `precedent-scheduling-ops`=10008 created via API 3 Jul; full flip cycle HTTP-verified (see `Idea/refinement/06-session-working-notes.md` §1.2) | ✅ done |
