...
> - **Run this AFTER `Prompts/07-ultracode-code-excellence.md` has merged its P1.7 console upgrade** (real Approve gate + chips) — the captures should show the best console. If 07 hasn't run, this prompt still works against the Checkpoint 2 tree; the session must state which tree it captured.
