...
> Prep artifact, 3 Jul 2026. Depth 1 is for whoever fields engineer/judge questions (source of truth: `Idea/refinement/02-architecture-refinement.md`). Depth 2 is the plain-English version for N1/N2 — read it once and you can explain the whole product without a single acronym. Each depth ≤2 pages.
